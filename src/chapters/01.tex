...
\item \emph{\Cref{chapter:chosentechnologies}} introduces the main technologies, which I built Diplomatiq on.
...
\item \emph{\Cref{chapter:diplomatiq}} demonstrates the Diplomatiq social network application with its specification, client-server architecture, features and development methods, and implementation details.
